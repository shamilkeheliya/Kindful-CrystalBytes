...
class FoodDonatorReports extends StatefulWidget {
  @override
  _FoodDonatorReportsState createState() => _FoodDonatorReportsState();
}

class _FoodDonatorReportsState extends State<FoodDonatorReports> {
  final Stream<QuerySnapshot> _Stream = FirebaseFirestore.instance
      .collection('reports')
      .where('read', isEqualTo: false)
      .where('reporteeType', isEqualTo: 'food_donator')
      .snapshots();
