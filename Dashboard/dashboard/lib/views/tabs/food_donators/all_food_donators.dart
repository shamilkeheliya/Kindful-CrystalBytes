...
class AllFoodDonators extends StatefulWidget {
  @override
  _AllFoodDonatorsState createState() => _AllFoodDonatorsState();
}

class _AllFoodDonatorsState extends State<AllFoodDonators> {
  final Stream<QuerySnapshot> _Stream =
      FirebaseFirestore.instance.collection('food_donators').snapshots();
