...
class OrganizationsVefirication extends StatefulWidget {
  @override
  _OrganizationsVefiricationState createState() =>
      _OrganizationsVefiricationState();
}

class _OrganizationsVefiricationState extends State<OrganizationsVefirication> {
