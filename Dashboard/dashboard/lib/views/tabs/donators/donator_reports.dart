...
class DonatorReports extends StatefulWidget {
  @override
  _DonatorReportsState createState() => _DonatorReportsState();
}

class _DonatorReportsState extends State<DonatorReports> {
  final Stream<QuerySnapshot> _Stream = FirebaseFirestore.instance
      .collection('reports')
      .where('read', isEqualTo: false)
      .where('reporteeType', isEqualTo: 'donator')
      .snapshots();
