...
class ReportFoodDonator extends StatefulWidget {
  late String userID, donatorID, donatorName;
  ReportFoodDonator(this.userID, this.donatorID, this.donatorName);

  @override
  _ReportFoodDonatorState createState() => _ReportFoodDonatorState();
}

class _ReportFoodDonatorState extends State<ReportFoodDonator> {
  ...
  Widget build(BuildContext context) {
    return ModalProgressHUD(
      ...
      child: Scaffold(
        appBar: kAppBar('Report Food Donator', true),
        body: ListView(
          children: [
