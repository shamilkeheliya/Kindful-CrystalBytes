    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const SizedBox(height: 20),
          kProfileListTile(
              Icons.add_business_outlined, name, 'Organization Name'),
          kProfileListTile(Icons.location_city_outlined, city, 'City'),
          kProfileListTile(Icons.map_outlined, district, 'District'),
          kProfileListTile(Icons.location_on_outlined, address, 'Address'),
          kProfileListTile(Icons.star_outline, type, 'Organization Type'),
