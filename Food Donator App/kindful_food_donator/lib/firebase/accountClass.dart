...
import 'package:kindful_food_donator/main.dart';

class Accounts {
  Future<bool> createAccount(
      id, name, email, phone, city, district, type) async {
    bool result = false;

    await FirebaseFirestore.instance.collection('food_donators').doc(id).set({
      'name': name,
      'email': email,
      'phone': phone,
      'city': city,
