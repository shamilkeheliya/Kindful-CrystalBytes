...
class ReportUser extends StatefulWidget {
  late String userID, organizationID, organizationName;
  ReportUser(this.userID, this.organizationID, this.organizationName);
  @override
...
class _ReportUserState extends State<ReportUser> {
  ...
  Widget build(BuildContext context) {
    return ModalProgressHUD(
      ...
      child: Scaffold(
        appBar: kAppBar('Report Organization', true),
        body: ListView(
          children: [
            ...
            Padding(
              ...
              child: TextField(
                decoration:
                    kTextInputDecoration(widget.organizationName, false),
  ...
  void validateForm() {
    ...
    if (descriptionTEC.text.isNotEmpty) {
      ...
      FirebaseFirestore.instance.collection('reports').add({
        ...
        'reporterType': 'food_donator',
        'reportee': widget.organizationID,
        'reporteeType': 'organization',
